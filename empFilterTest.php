...
$query = "SELECT series_id, pub_year, pub_name, pub_author, pub_sec_author, pub_url, pub_scale, keywords, bookstore_url FROM UGSpubs WHERE keywords LIKE '%emppub%' ORDER BY pub_year DESC, pub_month DESC";
