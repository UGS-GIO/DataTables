...
$query = "SELECT series_id, pub_year, pub_name, pub_author, pub_sec_author, pub_url, pub_scale, keywords, bookstore_url, quad_name, servName, cam_offset, lat, longitude, popupFL, pubPrevLink, pubPrevLink2, pubPrevLink3, series FROM UGSpubs WHERE series_id NOT LIKE 'WCD%' AND  ifnull(keywords,'') NOT LIKE '%emmd%' ORDER BY pub_year DESC, pub_month DESC";
...
$result->bind_result($SeriesID, $PubYear, $PubName, $PubAuthor, $PubSecAuthor, $PubURL, $PubScale, $KeyWords, $BookstoreURL, $QuadName, $ServiceName, $CameraOffset, $Latitude, $Longitude, $PopupFeatureLayer, $PubPrevLink, $pubPrevLink2, $pubPrevLink3, $Series);
