...
$query = "SELECT series_id, pub_year, pub_name, pub_author, pub_sec_author, pub_url, pub_scale, quad_name, keywords, bookstore_url, servName FROM UGSpubs WHERE keywords LIKE '%geoindex%' ORDER BY TRIM(LEADING 'The ' FROM quad_name)";
...
$result = $mysqli->prepare($query);
	...
	$result->bind_result($SeriesID, $PubYear, $PubName, $PubAuthor, $PubSecAuthor, $PubURL, $PubScale, $QuadName, $KeyWords, $BookstoreURL, $ServiceName);
